...
-- 插入訂單測試資料
INSERT INTO orders (id, commodity_name, commodity_type, unit_price, quantity, dealer_name, dealer_id, dealer_email, dealer_phone, order_date, deadline_date) VALUES (1, 'apple', 'Z232', 30.0, 10.0, 'Andy', 'C487', 'dealer1@email.com', '0922222222', '2025-06-01 11:00', '2025-06-02 15:30');
INSERT INTO orders (id, commodity_name, commodity_type, unit_price, quantity, dealer_name, dealer_id, dealer_email, dealer_phone, order_date, deadline_date) VALUES (7, 'Ulti-Meatum', 'Y213', 12.0, 5.0, 'Betty', 'C488', 'dealer2@email.com', '0922222223', '2025-06-04 13:45', '2025-06-22 18:00');
